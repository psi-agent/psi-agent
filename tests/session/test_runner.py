...
class TestReasoningParameters:
    """Tests for reasoning parameters in session requests."""
    ...
    @pytest.mark.asyncio
    async def test_run_conversation_includes_thinking_toggle(self, config_with_reasoning):
        """Test _run_conversation includes thinking toggle in request body."""
        ...
        async with runner:
            ...
            # Check thinking toggle is included
    ...
    @pytest.mark.asyncio
    async def test_stream_conversation_includes_thinking_toggle(self, config_with_reasoning):
        """Test _stream_conversation includes thinking toggle in request body."""
        runner = SessionRunner(config_with_reasoning)
        async with runner:
            # Create streaming response mock
            sse_lines = [
    ...
    @pytest.mark.asyncio
    async def test_complete_fn_includes_thinking_toggle(self, config_with_reasoning):
        """Test _complete_fn includes thinking toggle in request body."""
        runner = SessionRunner(config_with_reasoning)
        async with runner:
            mock_response = AsyncMock()
            mock_response.status = 200
