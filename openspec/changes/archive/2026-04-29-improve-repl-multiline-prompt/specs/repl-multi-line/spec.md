...
#### Scenario: Continuation prompt visibility
- **WHEN** user is entering continuation lines (lines after the first)
- **THEN** a visible continuation prompt (`. `) SHALL be displayed instead of spaces
